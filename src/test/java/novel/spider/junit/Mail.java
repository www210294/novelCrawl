...
public class Mail {
    ...
    public static String myEmailAccount = "BUPT_weiwenwu@163.com";
    public static String myEmailPassword = "123456789qq";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "541817807@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String msg) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "Java邮件", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "XX用户", "UTF-8"));

        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
        message.setSubject("通知消息", "UTF-8");
